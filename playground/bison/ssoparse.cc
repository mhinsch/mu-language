...
{
       9,     0,    -1,     4,    10,     5,    -1,    10,    11,     6,
      -1,    11,     6,    -1,     3,     7,    12,    -1,    12,     3,
      -1,     3,    -1
};
...
#line 36 "sso.y"
  ...
  case 3:
#line 39 "sso.y"
    { yyval = yyvsp[-2]; yyval.insert(yyval.end(), yyvsp[-1].begin(), yyvsp[-1].end()); ;}
    break;

  case 5:
#line 43 "sso.y"
    { yyval = yyvsp[-2]; yyval.push_back("="); 
