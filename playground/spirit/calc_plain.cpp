...
template<class CH1, class CH2=CH1>
struct Binary
	{
	CH1 child1;
	CH2 child2;
...
struct Add : public Binary<Node>, Node
	{};
struct Mult : public Binary<Node>, Node
	{};
...
struct calculator : public grammar<calculator>
    ...
    struct definition
        ...
        definition(calculator const& /*self*/)
			...
			declare
				= vtype >> name >> !('=' >> expression);
			
			vtype
				= str_p("int") | str_p("unsigned");
        ...
        rule<ScannerT> statement, declare, vtype, assign, name, expression, term, factor;
